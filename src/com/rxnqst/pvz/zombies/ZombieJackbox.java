...
public class ZombieJackbox extends Zombie {
    ...
    public static final Point frameSizeEat = new Point(74, 108);
    public static final Point frameSizeWalk = new Point(74, 108);
    public ZombieJackbox(int posX, int line) {
        super(posX, line, 400, 0, 3, ImageManager.ImgName.ZOMBIE_JACKBOX,
                AnimationManager.getTexture(AnimationManager.AtlasName.ZOMBIE_JACKBOX_WALK),
                AnimationManager.getTexture(AnimationManager.AtlasName.ZOMBIE_JACKBOX_WALK));
    ...
    public ZombieJackbox(Zombie zombie) {
        super(zombie.hitbox.x, zombie.line, zombie.hp, zombie.dmg, zombie.speed,
                ImageManager.ImgName.ZOMBIE_JACKBOX,
                AnimationManager.getTexture(AnimationManager.AtlasName.ZOMBIE_JACKBOX_WALK),
                AnimationManager.getTexture(AnimationManager.AtlasName.ZOMBIE_JACKBOX_WALK));
